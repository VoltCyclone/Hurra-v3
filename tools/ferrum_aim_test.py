...
Setup required:
    ...
    2. CH32H417 board's USBFS device port plugged into Mac     (HID injection out)
    3. A real USB mouse plugged into the board's USBHS host port
       — the firmware is a HID proxy; it requires an upstream device to enumerate.
